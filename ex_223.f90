...
real(mp), allocatable :: A(:,:) ,b(:), A_save(:,:) ,b_save(:), G(:,:), G_trans(:,:) !, r(:), d(:), L(:,:), Diag(:,:), y(:),u_ans(:), upper(:,:) 
...
allocate(A(1:n,1:n),b(1:n),A_save(1:n,1:n),b_save(1:n),G(1:n,1:n), G_trans(1:n,1:n) ) !,r(1:n), d(1:n), L(1:n,1:n),Diag(1:n,1:n) , y(1:n), u_ans(1:n), upper(1:n,1:n) )  
